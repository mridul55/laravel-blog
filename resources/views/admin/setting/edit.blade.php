                        ...
                        <div class="row">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="name" class="form-control" name="title" value="{{ $setting->title }}"
                                        placeholder="Enter Insert setting Title">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <option value="{{ $c->id }}" @if($setting->category_id == $c->id ) selected @endif>{{ $c-> name}} </option>
                                        @endforeach
                                        </select>
                                    </div>
